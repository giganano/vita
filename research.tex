...
\newcommand{\citationcount}[1]{
	\color{themecolor} \fontsize{22}{30} \selectfont #1 \vspace{3mm}
}
...
\parbox{0.8\textwidth}{%
	\vspace{1mm}
	\textbf{APOGEE's Galactic Odyssey} \hfill 2026 \par
	Centro de Estudios de Fisica del Cosmos de Arag{\'o}n (Teruel, Spain) \par
	\textbf{Sloan Digital Sky Survey (SDSS) Collaboration Meetings} \par
	\qquad Katholieke Universiteit Leuven (Leuven, Belgium) \hfill 2026 \par
	\qquad Max Planck Institut f{\"u}r Astronomie (Heidelberg, Germany) \hfill 2025 \par
	\qquad New Mexico State University (Las Cruces, NM) \hfill 2024 \par
	\qquad Virtual \hfill 2021 \par
	\qquad Virtual \hfill 2020 \par
}
...
\parbox{0.8\textwidth}{%
	\vspace{1mm}
	\textbf{Galactic Metal Cycles}, University of Notre Dame (Kylemore Abbey,
	Ireland) \hfill 2026 \par
	\textbf{University of California, Davis}, Dept. of Physics and Astronomy (Davis, CA)
	\hfill 2025 \par
	...
	\textbf{241$^\text{st}$ American Astronomical Society Meeting} (Seattle, WA)
	\hfill 2023 \par
	\textbf{GALactic Archaeology with Hermes (GALAH) Science Meeting}
	\hfill 2021 \par
	(virtual) \par
	\textbf{236$^\text{th}$ American Astronomical Society Meeting} (virtual)
	\hfill 2020 \par
